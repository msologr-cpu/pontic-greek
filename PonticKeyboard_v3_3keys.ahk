...
; ==============================================================================
; Понтийская Греческая Раскладка (Pontic Greek) — Windows AHK v3.2 (3 клавиши)
; ==============================================================================
            ...
            if !WinWaitClose(hwnd, 1.5) {
                result := MsgBox(
                  ...
                  . "Закрыть старую копию и запустить новую?",
                    "Pontic Keyboard v3.2 (3 клавиши)", "YesNo Icon?"
                )
                if (result == "Yes") {
                    try {
...
$*vkBC:: {
    ...
    if (char == "ζ")
        ...
        ; S key (0x53) = медиальная σ, W key (0x57) = конечная ς
        if (g_LastVK == 0x57)
