...
Замечание носитель языка (v5.0): над буквами ξ ζ χ ψ и Σ Ξ Ζ Χ Ψ гачек нужно сдвинуть
...
Наш алгоритм считает центр верно математически — носитель языка как носитель языка
...
# Буквы из замечания носитель языка → величина сдвига вправо задаётся при вызове.
#
# ВАЖНО: ψ (U+03C8) и Ψ (U+03A8) в список НЕ входят.
# В первом замечании носитель языка называл их, но, посмотрев варианты на картинке,
...
# Согласованная с носитель языка величина оптической поправки (единиц при upem=1000).
OPTICAL_SHIFT = 15
