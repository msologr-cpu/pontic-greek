...
if [ ! -f "$SOURCE" ]; then
  ...
  echo "Запустите скрипт из корня репозитория pontic/"
  exit 1
fi
...
# Проверяем наличие уже установленного
...
echo "   • Cmd+Space  — переключить язык"
echo "   • Клик на флаге в меню-баре — выбор вручную"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo -e "Читайте подробную инструкцию: ${YELLOW}ИНСТРУКЦИЯ.md${NC}"
echo ""
