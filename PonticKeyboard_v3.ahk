...
; ==============================================================================
; Понтийская Греческая Раскладка (Pontic Greek) — Windows AHK v4.1
; ==============================================================================
; Единая понтийская мёртвая клавиша / (слэш) поверх стандартной греческой
; раскладки Windows.
;
; Изменения v4.1:
; - ИСПРАВЛЕНА КОНЕЧНАЯ СИГМА ς̌ (по отзыву носитель языка: «не пропечатывается вообще,
...
; ==============================================================================
; Причина проблем носителя языка:
...
; ==============================================================================
; Страховка: типографский апостроф после τ / Τ (на случай, если автозамену
